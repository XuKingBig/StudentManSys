...
public class DoubleLinkList {
    ...
    public String deleteANode(String name){
        ...
        for(Node n = first; n != null; n = n.next){
            ...
            if(name.equals(n.obj.getSname())) {
                ...
                //如果要删除的人是表尾
                else if(n.next == null) n.previous.next = null;
                //如果要删除的人在中间
    ...
    public void showDoubleLinkList(){
        for(Node n = first; n != null; n = n.next)
            System.out.println(n.getObj().getSname() + n.getObj().getSid() +"    "+"    "+ String.valueOf(n.getObj().getTotalMark()) +"    "+
                    ...
                    String.valueOf(n.getObj().getEconomy() +"    "+ String.valueOf(n.getObj().getTax())
                            +"    "+ String.valueOf(n.getObj().getWeb())));
    }
